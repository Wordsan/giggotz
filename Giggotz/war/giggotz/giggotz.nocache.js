...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "giggotz" because\n';
  ...
  $wnd.__gwt_activeModules['giggotz'] = {
    'moduleName' : 'giggotz',
    'bindings' : function() {
      return {};
    }
 ...
 * "/giggotz.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['giggotz'].superdevmode = true;

  var expectedSuffix = '/giggotz.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + giggotz + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:giggotz';
  var devModeSessionKey = '__gwtDevModeSession:giggotz';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/giggotz/giggotz.nocache.js';
  ...
  $wnd.__gwt_activeModules['giggotz'].canRedirect = true;
  $wnd.__gwt_activeModules['giggotz'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/giggotz?user.agent=' + ua + '&_callback=' + callback;
